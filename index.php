        ...
        <div class="container-login100">
            <div class="wrap-login100">
				...
				if ($_SERVER['REQUEST_METHOD']=='POST') {
					...
					if ($level==1) {
						// Guru
						$sqlCek = mysqli_query($con,"SELECT * FROM tb_guru WHERE nip='$_POST[username]' AND password='$pass' AND status='1'");
						...
						// Siswa
								$sqlCek = mysqli_query($con,"SELECT * FROM tb_siswa WHERE nisn='$_POST[username]' AND password='$pass' AND status='1'");
								$jml = mysqli_num_rows($sqlCek);
								$d = mysqli_fetch_array($sqlCek);
						...
						// Kepsek
								$sqlCek = mysqli_query($con,"SELECT * FROM tb_kepsek WHERE nip='$_POST[username]' AND password='$pass' AND status='1' ");
								$jml = mysqli_num_rows($sqlCek);
								$d = mysqli_fetch_array($sqlCek);
