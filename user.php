        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/logo.png" alt="navbar brand" class="navbar-brand" width="40">
                        <b class="text-white">Sistem Akademik</b>
                    </a>
                </div>
            </div>
            <!-- End Logo Header -->
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK Negeri 1 Way Bungur</h2>
                                    <h5 class="text-white op-7 mb-2">Sistem Akademik Sekolah</h5>
                                </div>
