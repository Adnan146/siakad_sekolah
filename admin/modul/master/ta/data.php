        ...
        <div class="card-header">
          <div class="card-title">
            <a href="" class="btn btn-primary btn-sm text-white" data-toggle="modal"
              data-target="#addTahun Pelajaran"><i class="fa fa-plus"></i> Tambah</a>
          </div>
        </div>
        <div class="card-body">
          <div class="card-body">
                  ...
                  foreach ($ta as $t) { ?>
                    <tr>
                      ...
                      <td>
                        ...
                        if ($t['status'] == 0) {
                          ?>
                          <a onclick="return confirm('Yakin Aktifkan Ta  ??')"
                            href="?page=master&act=set_ta&id=<?= $t['id_thajaran'] ?>&status=1"
                            class="btn btn-success btn-sm"><i class="fas fa-check-circle"></i> Aktifkan</a>
                          <?php

                        } else {
                          ?>
                          <a onclick="return confirm('Yakin Non-Aktifkan Ta  ??')"
                            href="?page=master&act=set_ta&id=<?= $t['id_thajaran'] ?>&status=0"
                            class="btn btn-danger btn-sm"><i class="far fa-times-circle"></i> Nonaktif</a>
                          <?php
                        }
                        ...
                        <a href="" class="btn btn-primary btn-sm" data-toggle="modal"
                          data-target="#edit<?= $t['id_thajaran'] ?>"><i class="far fa-edit"></i> Edit</a>
                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')"
                          href="?page=master&act=delta&id=<?= $t['id_thajaran'] ?>"><i class="fas fa-trash"></i> Del</a>

                        <!-- Modal -->
                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                          id="edit<?= $t['id_thajaran'] ?>" class="modal fade" style="display: none;">
                                  ...
                                  <div class="row">
                                    <div class="col-md-10">
                                      <div class="form-group">
                                        ...
                                        <input name="tp" type="text" value="<?= $t['tahun_ajaran'] ?>"
                                          class="form-control">
                                      </div>
                                      <div class="form-group">
...
<!-- Modal -->
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="addTahun Pelajaran"
