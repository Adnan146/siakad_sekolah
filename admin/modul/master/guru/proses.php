...
if (isset($_POST['saveGuru'])) {
	...
	if ($pindah) {
		...
		if ($save) {
			echo "
				...
				window.location.replace('?page=master&act=guru');
				} ,3000);   
				</script>";
		}
	}
	...
	$editGuru = mysqli_query($con, "UPDATE tb_guru SET nip='$_POST[nip]',nama_guru='$_POST[nama]',email='$_POST[email]', password='$pass' WHERE id_guru='$_POST[id]' ");
